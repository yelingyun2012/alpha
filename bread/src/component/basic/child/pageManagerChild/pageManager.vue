  ...
  methods: {
    ...
    initQuery() {
      pageModelQuery({
        ...
        this.$refs.pageBasic.basicData.modelRegularExpression =
          queryData.modelRegularExpression;
        this.$refs.pageBasic.basicData.urlsAllowCrawlRegex =
          queryData.urlsAllowCrawlRegex;
        this.$refs.pageBasic.basicData.urlsNotAllowCrawlRegex =
          queryData.urlsNotAllowCrawlRegex;
        this.$refs.pageBasic.basicData.urlExtractable =
          queryData.urlExtractable;
        this.$refs.pageBasic.basicData.browserCrawlable =
          queryData.browserCrawlable;
        this.$refs.pageBasic.basicData.pageTurningable =
          queryData.pageTurningable;

        this.$refs.pageBasic.basicData.urlExtractRule =
          queryData.urlExtractRule;
        this.$refs.pageBasic.basicData.urlExtractRuleType =
          queryData.urlExtractRuleType;

        if (queryData.browserCrawlable === 2) {
          ...
          this.$refs.pageBasic.basicData.loadFinishedDecisionRule =
            queryData.browserRefreshConfigureEntity[0].loadFinishedDecisionRule;
        ...
        if (
          queryData.pageModelPropertyEntity !== null &&
          queryData.pageModelPropertyEntity.length !== 0
        ) {
