      ...
      return {
        ...
        taskColumns: [
          ...
          },
          {
            ...
            render: (h, params) => {
              if (params.row.startTime !== undefined) return `${params.row.startTimes.split(' ')[0]} ~ ${params.row.endTimes.split(' ')[0]}`
            }
          },
          {title: '创建时间', width: 85, align: 'center', key: 'createTimes'},
          {
            ...
            render: (h, params) => {
              ...
              } else { return `${params.row.lastCrawlTime}` }
            }
          },
          ...
          {title: '抽取率', width: 60, align: 'center', key: 'extractionRate'},
          {
